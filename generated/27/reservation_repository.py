...
class ReservationRepository:
    ...
    def create_reservation(self, customer_id: int, room_id: int, start_date: str, end_date: str, status: str) -> int:
        with self.db.connect() as conn:
            cursor = conn.cursor()
            cursor.execute('INSERT INTO reservations (customer_id, room_id, start_date, end_date, status) VALUES (?, ?, ?, ?, ?)', (customer_id, room_id, start_date, end_date, status))
            conn.commit()
