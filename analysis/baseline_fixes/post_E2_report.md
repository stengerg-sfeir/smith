...
|---|---|---|---|---|---|---|
| `cli_tool` | 11.7 | propre | OK | **PASS** | **PASS** | pass 5/5 |
| `expenses` | 390.9 | propre | OK | **PASS** | **PASS** | pass 14/14 |
| `hello_world` | 2.0 | propre | OK | **PASS** | **PASS** | no_mapped 0/0 |
| `inventory` | 233.2 | propre | OK | **PASS** | **PASS** | pass 11/11 |
| `library_system` | 217.5 | propre | OK | **PASS** | **PASS** | pass 9/9 |
| `multi_module` | 143.0 | propre | OK | **PASS** | **PASS** | pass 5/5 |

## `cli_tool`

- génération : **11.7 s** (exit 0)
...
_Généré le 2026-09-18T12:27:04.238382+00:00._
