...
|---|---|---|---|---|---|---|
| `cli_tool` | 12.3 | propre | OK | **PASS** | **PASS** | pass 5/5 |
| `expenses` | 376.0 | propre | OK | **PASS** | **PASS** | pass 14/14 |
| `hello_world` | 2.0 | propre | OK | **PASS** | **PASS** | no_mapped 0/0 |
| `inventory` | 210.4 | propre | OK | **PASS** | **PASS** | pass 11/11 |
| `library_system` | 216.6 | propre | OK | **PASS** | **PASS** | pass 9/9 |
| `multi_module` | 136.1 | propre | OK | **PASS** | **PASS** | pass 5/5 |

## `cli_tool`

- génération : **12.3 s** (exit 0)
...
_Généré le 2026-09-17T19:05:44.513374+00:00._
