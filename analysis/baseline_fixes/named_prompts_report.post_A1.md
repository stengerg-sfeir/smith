...
|---|---|---|---|---|---|---|
| `cli_tool` | 12.5 | propre | OK | **PASS** | **PASS** | pass 5/5 |
| `expenses` | 405.3 | propre | OK | **PASS** | **PASS** | pass 14/14 |
| `hello_world` | 1.8 | propre | OK | **PASS** | **PASS** | no_mapped 0/0 |
| `inventory` | 210.3 | propre | OK | **PASS** | **PASS** | pass 11/11 |
| `library_system` | 200.7 | propre | OK | **PASS** | **PASS** | pass 9/9 |
| `multi_module` | 130.6 | propre | OK | **PASS** | **PASS** | pass 5/5 |

## `cli_tool`

- génération : **12.5 s** (exit 0)
...
_Généré le 2026-09-17T22:22:31.357342+00:00._
