...
|---|---|---|---|---|---|---|
| `cli_tool` | 12.1 | propre | OK | **PASS** | **PASS** | pass 5/5 |
| `expenses` | 375.2 | propre | OK | **PASS** | **PASS** | pass 14/14 |
| `hello_world` | 2.1 | propre | OK | **PASS** | **PASS** | no_mapped 0/0 |
| `inventory` | 229.3 | propre | OK | **PASS** | **PASS** | pass 11/11 |
| `library_system` | 220.5 | propre | OK | **PASS** | **PASS** | pass 9/9 |
| `multi_module` | 133.5 | propre | OK | **PASS** | **PASS** | pass 5/5 |
...
_Généré le 2026-09-18T18:23:32.841073+00:00._
