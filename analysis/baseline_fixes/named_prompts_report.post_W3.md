...
|---|---|---|---|---|---|---|
| `cli_tool` | 12.4 | propre | OK | **PASS** | **PASS** | pass 5/5 |
| `expenses` | 409.5 | propre | OK | **PASS** | **PASS** | pass 14/14 |
| `hello_world` | 2.0 | propre | OK | **PASS** | **PASS** | no_mapped 0/0 |
| `inventory` | 222.9 | propre | OK | **PASS** | **PASS** | pass 11/11 |
| `library_system` | 211.2 | propre | OK | **PASS** | **PASS** | pass 9/9 |
| `multi_module` | 135.5 | propre | OK | **PASS** | **PASS** | pass 5/5 |

## `cli_tool`

- génération : **12.4 s** (exit 0)
...
_Généré le 2026-09-17T19:54:07.021682+00:00._
