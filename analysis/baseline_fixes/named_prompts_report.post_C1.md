...
|---|---|---|---|---|---|---|
| `cli_tool` | 11.2 | propre | OK | **PASS** | **PASS** | pass 5/5 |
| `expenses` | 393.9 | propre | OK | **PASS** | **PASS** | pass 14/14 |
| `hello_world` | 2.0 | propre | OK | **PASS** | **PASS** | no_mapped 0/0 |
| `inventory` | 222.7 | propre | OK | **PASS** | **PASS** | pass 11/11 |
| `library_system` | 213.4 | propre | OK | **PASS** | **PASS** | pass 9/9 |
| `multi_module` | 136.9 | propre | OK | **PASS** | **PASS** | pass 5/5 |

## `cli_tool`

- génération : **11.2 s** (exit 0)
...
_Généré le 2026-09-18T07:02:55.042489+00:00._
