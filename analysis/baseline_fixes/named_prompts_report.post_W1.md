...
|---|---|---|---|---|---|---|
| `cli_tool` | 13.1 | propre | OK | **PASS** | **PASS** | pass 5/5 |
| `expenses` | 418.7 | propre | OK | **PASS** | **PASS** | pass 14/14 |
| `hello_world` | 2.0 | propre | OK | **PASS** | **PASS** | no_mapped 0/0 |
| `inventory` | 232.0 | propre | OK | **PASS** | **PASS** | pass 11/11 |
| `library_system` | 223.7 | propre | OK | **PASS** | **PASS** | pass 9/9 |
| `multi_module` | 143.9 | propre | OK | **PASS** | **PASS** | pass 5/5 |

## `cli_tool`

- génération : **13.1 s** (exit 0)
...
_Généré le 2026-09-17T20:30:24.404902+00:00._
