...
class OrderLineRepository:
    ...
    def get_order_line_total_by_product(self, product_id: int, start_date: datetime, end_date: datetime) -> float:
        return self.list(
            product_id=product_id,
        )
    ...
    def validate_order_line_data(self, order_line_data: dict) -> bool:
        ...
        if not required_fields.issubset(order_line_data.keys()):
            return False
        try:
            order_id = order_line_data['order_id']
