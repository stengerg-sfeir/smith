...
TEST_SPEC = {'entities': [{'name': 'Customer',
               'fields': [{'name': 'id',
                           'type': 'int',
                           'nullable': False,
                           'unique': True,
                           'auto': 'autoincrement'},
                          {'name': 'name', 'type': 'str', 'nullable': False, 'unique': False}],
              ...
              {'name': 'InvoiceLine',
               'fields': [{'name': 'id',
                           ...
                           'unique': True,
                           'auto': 'autoincrement'},
                          {'name': 'invoice_id', 'type': 'int', 'nullable': False, 'unique': False},
                          {'name': 'product_id', 'type': 'int', 'nullable': False, 'unique': False},
                          {'name': 'quantity', 'type': 'int', 'nullable': False, 'unique': False},
                          {'name': 'unit_price',
                           'type': 'float',
                           'nullable': False,
                           'unique': False}],
 ...
 'services': [{'module': 'services',
               ...
               'methods': [{'name': 'calculate_invoice_total',
                            'params': [{'name': 'invoice_lines', 'type': 'list'}],
                            'returns': 'float'}],
               'entity': ''}],
 'seed': {'data': [{'entity': 'Customer', 'data': [{'name': 'Acme Corp'}]},
                   {'entity': 'Product',
                    'data': [{'name': 'Laptop', 'unit_price': 1000.0},
                             {'name': 'Mouse', 'unit_price': 25.0}]},
                   {'entity': 'Invoice', 'data': [{'customer_id': 1, 'total': 0.0}]},
                   {'entity': 'InvoiceLine',
                    'data': [{'invoice_id': 1,
                              'product_id': 1,
                              'quantity': 1,
